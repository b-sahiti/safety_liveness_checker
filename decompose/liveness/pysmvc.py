        ...
        if (((packets[l[0]]) in prop[0]) or (packets[l[0]]) == "*") and prop[1] == actions[l[0]]:
            ...
            if (packets[l[0]]) == "*":
                ...
                while (packets[l[0]]) in temp[0]:
                    ...
                    temp[0] = s
            return (l[0] + "&" + l1[0] + "&" + getprop(temp, l[(1):], l1[(1):], actions, packets) + "|" + "!" + "(" + l[
                0] + "&" + l1[0] + ")" + "&" + getprop(pval, l[(1):], l1[(1):], actions, packets))
...
def helper(g, prop, smv_filename):
    ...
    for i in range(1, len(r)):
        ...
        if t == 1:
            ...
            b.write(
                "\t\t" + "self.active & " + "r" + r[i][0][1] + "1.active : " + str(-(48 - ord(r[i][3][ind + 3]))) + ";")
            b.write("\n")
