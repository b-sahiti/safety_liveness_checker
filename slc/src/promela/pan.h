...
#define _nstates1	6	/* A1 */
#define minseq1	5
#define maxseq1	9
#define _endstate1	5

#define _nstates0	6	/* A0 */
#define minseq0	0
#define maxseq0	4
#define _endstate0	5
...
#define HAS_TRACK	0
/* hidden variable: */	uchar r2;
/* hidden variable: */	uchar r3;
/* hidden variable: */	uchar r4;
/* hidden variable: */	uchar r5;
